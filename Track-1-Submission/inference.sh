...
echo "Processing CellViT++"
python ./cellvit-inference/track_1_3_prediction.py \
    --cellvit_path ./cellvit-inference/checkpoint/CellViT-SAM-H-x40-AMP.pth\
    --classifier_path ./cellvit-inference/checkpoint/classifier-track1-3-classes.pth \
    --input_file "$input_file" \
    --output_file /output/melanoma-3-class-nuclei-segmentation.json