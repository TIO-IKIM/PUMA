...
class CellViTInfExpSegmentationParser:
    def __init__(self) -> None:
        ...
        parser.add_argument(
            "--cellvit_path", type=str, help="Path to the Cellvit model", default="/home/jovyan/cellvit-data/cellvit/cellvit/checkpoints/CellViT-SAM-H-x40-AMP.pth"
        )
        parser.add_argument(
            "--classifier_path", type=str, help="Path to the classifier model", default="/home/jovyan/cellvit-data/cellvit/inference-puma/checkpoint/classifier-track2-10-classes.pth"
        )
        parser.add_argument(
            "--input_file", type=str, help="Path to input file (.png or .tiff)", default="/home/jovyan/cellvit-data/PUMA-CellViT/track-2/test/images/training_set_metastatic_roi_003.png"
        )
        parser.add_argument(
            "--output_file", type=str, help="Path to output file .json", default="test.json"
        )
        self.parser = parser
